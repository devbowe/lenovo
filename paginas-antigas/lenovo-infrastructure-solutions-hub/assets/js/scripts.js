...
$('#typed').typed({
    strings: ["el futuro", "Edge Computing", "Inteligencia Artificial y Analytics", "Everything As a Service", "Infraestrutura Hiperconvergente", "Servidores y Storage"],
    typeSpeed: 30,
    loop: true,
    backSpeed: 20,
    backDelay: 500
...
// load form news
MktoForms2.loadForm("//app-ab27.marketo.com", "183-WCT-620", 21847, function (form) {
...
//load form
MktoForms2.loadForm("//app-ab27.marketo.com", "183-WCT-620", 3099, function (form) {
